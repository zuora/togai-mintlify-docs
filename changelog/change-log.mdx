...
<Update label="14th October 2024">
  ...
  - We've launched embeddable [widgets](https://docs.togai.com/docs/ui-widgets) for usage and revenue metrics, credit and wallet balances and price plan and schedule. Even more to come!
  ...
  - Support Single Sign-On (SSO) via WorkOS 
</Update>

<Update label="16th July 2024">
...
<Update label="24th June 2024 ">
  ...
  - Account details
  - Usage and cost metrics of the account
  - Price Plan Schedule details of the account
  - Wallet details of the account
  - Past and Ongoing Invoice details of the account
  - Credit details and history of the account
</Update>

<Update label="20th May 2024 ">
  - Enabled stripe bank transfer for customers as a payment method if required
  - Implemented usage cycle/windows for named license
</Update>

<Update label="27th May 2024">
  - Added support for login to customer portal without email and password
  - Added custom operators on top of json logic to support date and duration operations.
  - Added named license metrics in dashboard
</Update>

<Update label="28th April 2024">
...
<Update label="24th March 2024">
  ...
  - Provision to execute flows between invoice Finalization and Due states. This helps to add taxes, e-invoicing, and PG
  sync before invoice goes to DUE.
  - Added authorization support in marketplace to validate permissions of user before serving requests.
</Update>

<Update label="17th March 2024">
  - Named license meter and add-on launched - this allows you to track unique license entries and apply different rating
  capabilities to this usage metric
  - [APIs to fetch named license entries](/api-reference/licenses/get-a-list-of-named-licenses-updates)
...
<Update label="10th March 2024">
  - [Support for bulk event void, update and reingestion based on certain query
  parameters](/api-reference/event-management/correct-an-ingested-event)
...
<Update label="3rd March 2024">
  ...
  - Minimum and maximum pricing values (commitment and ceiling) can now be configured at a rate card level, in addition
  to a slab level
...
<Update label="25th February 2024">
  ...
  - Custom dashboard widgets now allow you to visualize the data as pivot tables with row fields, column fields and the
...
<Update label="18th February 2024">
  ...
  - Flow enabled to recharge wallet through a payment gateway automatically for advance payments and pre-paid purchase
  orders
  - Flow to auto top-up a wallet balance using the credit card on file when the wallet balances goes below a user
  defined threshold
...
<Update label="11th February 2024">
  ...
  - Revenue simulator supports comparing any 2 price plans (you can ignore the default price plan for an account for
  comparison)
  - Microsoft Exchange email integration to send invoice and other emails from Microsoft registered domains
</Update>

<Update label="4th February 2024">
...
<Update label="28th January 2024">
...
<Update label="21st January 2024">

  - [Pricing rules](/docs/pricing-rules) to help you model any type of pricing
  - [Revenue simulator](/docs/revenue-simulator) helps you run backtests on actual usage data to compare business impact
...
<Update label="14th January 2024">
...
<Update label="7th January 2024">
  - Custom charges can now be created without impacting revenue
  - Now, you can store metadata with license purchases (use case example is where you can record PO number to submit to
  your customer for payment)
  - Effective browser caching for front end performance improvement
</Update>

<Update label="31st December 2023">
...
<Update label="24th December 2023">
  - Optimization of price plans to store in cache
  - Delayed/[deferred revenue computation](/docs/pricing-cycle) allows price plan edits from start of the current
  unbilled cycle and rerate the usage.
...
<Update label="17th December 2023">
...
<Update label="10th December 2023">
  - You can now create an invoice template and assign it to different customer accounts. Multiple invoice templates can
  be created.
...
<Update label="26th November 2023">
...
<Update label="19th November 2023">
  - Signup or Login with Microsoft account credentials (SSO via Microsoft)
  - Create custom invoice with line items (In DRAFT, DUE and PAID state - DRAFT invoices will become due on the said
  date)
...
<Update label="12th November 2023">
...
<Update label="5th November 2023">
...
<Update label="29th October 2023">
...
<Update label="22nd October 2023">
  - Now you can void an event and re-send it using the same id. This
  [API](/api-reference/event-management/undo-ingested-events#openapi-delete-events) allows you to correct old events
...
<Update label="15th October 2023">
  - Support for In-advance pro-rated fixed fees
  - Support for deletion for events
  - Edit entitlement grants in the dashboard
</Update>

<Update label="8th October 2023">
  - Fixed Fees are now supported in One-time price plans (Plan type: PURCHASE)
  - Entitlement quantities can now be used for Purchase plan too (entitlement quantity is used as the quantity of all
  the rate cards in Purchase plan)
  - Proration of fixed fees are now supported in `in-advance` timing mode.
  - Feature credit (Entitlement grants) entries can now be
  [updated](/api-reference/entitlements/update-a-feature-credits-entry-of-a-feature-for-an-account) as well as
  [voided](/api-reference/entitlements/void-a-feature-credits-entry-of-a-feature-for-an-account).
...
<Update label="1st October 2023">
  ...
  - Recording duplicate events for [/ingest](/api-reference/event-ingestion/ingest-events-to-togai) API. You can now
  view the events that failed idempotency checks in the list of unprocessed events.
</Update>

<Update label="24th September 2023">
...
<Update label="17th September 2023">
  - Support for configuring proration for license rate cards when the number of licenses are reduced and the refunds to
  be given as credits
  - Capture billing address and email id at an account level
  - Netsuite and Salesforce integrations
</Update>

<Update label="10th September 2023">
  ...
  - Entitlement credits purchase and usage logs (across entitlement rate card, overage rate card & entitlement plan
  purchase)
...
<Update label="3rd September 2023">
  - Weekly pricing cycle
  - Create an invoice group to consolidate invoices from multiple accounts into a single invoice
  - Support for pro-ration for In Advance license based rate cards when the number of licenses are reduced (handled by
  providing it as a credit)
  - Bulk import usage based rate cards in price plan through csv
</Update>

<Update label="25th August 2023">
  - New UI design
...
<Update label="9th August 2023">
  ...
  - Rate card level quantities when purchasing plans (support as a new type of plan: Purchase plan. entitlement plans
  will be deprecated)
  ...
  - Accepting billing address as granular sections (line 1, 2, city, state, zip) for better integration with 3rd party
  apps
...
<Update label="20th July 2023">

  - Togai now gives you the ability to migrate accounts from one price plan to another. You have 8 possible options to
  choose from.
</Update>

<Update label="7th July 2023">
